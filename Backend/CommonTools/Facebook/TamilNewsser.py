...
databaseUrl = "https://colabfacebook-default-rtdb.firebaseio.com/facebook/TamilNewsser/"
dataBase = firebase.FirebaseApplication(databaseUrl, None)
mainSitemap = "https://tamil.oneindia.com/sitemap-latest.xml"
postLink = "https://tamil.oneindia.com/television/shabana-put-an-end-to-the-rumors/articlecontent-pf631716-442939.html"
postLink1 = "https://tamil.oneindia.com/television/actor-arjun-confirmed-for-corona-infection/articlecontent-pf629036-442201.html"
...
def getPostData(postLink):
    ...
    try:
        ...
        # print(e)
        imgUrl = soup.find(
            "div", {"id": "mvp-post-feat-img"}).find("img").get_attribute_list("src")[0]
...
def Run():
    allPostLinks = exract(mainSitemap)
