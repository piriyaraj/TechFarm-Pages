...
const main = async () => {
    ...
    for (var i = lastchekedtable; i < allTableName.length; i++) {
        ...
        for (var j = 0; j < waLinkKeys.length; j++) {
            ...
            if(groupData[2]==null){
                console.log("invalid data remove");
