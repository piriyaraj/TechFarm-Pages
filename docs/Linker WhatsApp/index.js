...
preArtical =`<div class="entry-content" itemprop="text">
    ...
    <p><strong><span style="text-decoration: underline;">PostTitle <a data-wpel-link="internal" href="/" title="WhatsApp Group Links">WhatsApp Group Links</a>:</span></strong> <strong>Hey! PostTitle&nbsp;WhatsApp Group</strong>&nbsp;fan to hitch within the&nbsp;<strong>PostTitle&nbsp;<a data-wpel-link="internal" href="/" title="WhatsApp Group Links">WhatsApp group links</a></strong>&nbsp;simply
...
postArtical =`<div class="entry-content" itemprop="text">



    <h2>How to Join PostTitle WhatsApp Group Links Easily?</h2>



    <p>Yes, you see all links before this section. The reason for this section is to clear the doubt about how to join the PostTitle WhatsApp group links. Now we will give the step-by-step guidence. so that you can easily join the WhatsApp group. the steps
        are</p>



    <ul>
        <li>open the post on our site and select the WhatsApp group with imgae.</li>
        <li>Select the group link for you to join.</li>
        <li>Name and images help to join PostTitle groups</li>
        <li>After selecting the group then click the join button.</li>
        <li>After clicking the link the WhatsApp messenger will open.</li>
        <li>In the messenger, the popup window shows the join group and cancel.</li>
        <li>Click the join group button.</li>
        <li>If the group is not full you can join easily and get the benifite.</li>
    </ul>



    <p>These are the steps you have to follow to join the PostTitle WhatsApp group links. these are very easy steps so you can join every group.</p>



    <h2>PostTitle WhatsApp Group Links Rules:</h2>



    <ul>
        <li>Make sure only sharing entertainment or useful contents</li>
        <li>You have to give respect to all members of the group</li>
        <li>Don't share the illegal content</li>
        <li>Don't edit the group Name, Icon &amp; Description</li>
        <li>Don't use the group for the promotion purpose</li>
        <li>Don't make unhealthy arguments in the group</li>
        <li>You can contact group admin for any cases</li>
    </ul>
    ...
    <p>Yes, you can get useful links through this post. you can choose one of the links and join it we think you are like our all group links. if you link our post please share this post on your social media to help our site more visitors. Thank you for
        visiting the PostTitle WhatsApp Group Links.</p>
    <p><br /></p>



    <h2><strong>These are the FAQ's from users about PostTitle WhatsApp Group Links</strong></h2>
    <p>Our visitors raise some doubt about the groups or the steps for joining the <b>PostTitle </b>WhatsApp Group Links. we are trying to clarify their doubts. if you have more doubt you can use the comment section and put your doubt into it we will always
        be ready to help you to solve the problem</p>


    <section class="sc_fs_faq sc_card">
        <h2>Why can't join a Whatsapp group using the link?</h2>
        <div>
            <div class="sc_fs_faq__content">


                <p>There are some reasons for the group links are not working now we like to clarify the proferred reason for it. first this the created link was re-generated by the admin so that the link goes to invalid. another thing is group may be deleted
                    by the admin for personal reasons. so in this situation, you can't be joining a specific group sorry for saying this.</p>
    ...
    <section class="sc_fs_faq sc_card">
        ...
        <div>
            <div class="sc_fs_faq__content">
                ...
                <p>This answer will help the Whatsapp group admins to share their group publicly. After you create the group you click the group name inside the group. After you click the group name you can see all details about the groups. In there you
                    can find description, group icon, group name, group members, and invite links. so this is the last section for creating the invite link just press the section group links then the link will copy.</p>

            </div>
        </div>
    </section>
    <section class="sc_fs_faq sc_card">
        <h2>Where to Find Active WhatsApp Group Link?</h2>
        <div>
            <div class="sc_fs_faq__content">


                <p>There is some way to find active WhatsApp group links One method is requested to the admin to give the links for you. otherwise, you can't get the link for the specific URL. This is another way to get the public group URL search on to
                    google after that go to the sites and find the link. but here we will recommend visiting our site and just search the group category and join.</p>

            </div>
        </div>
    </section>
    <section class="sc_fs_faq sc_card">
        <h2>How to Delete WhatsApp Group?</h2>
        <div>
            <div class="sc_fs_faq__content">


                <p>In the Group info section, you can see the option the delete the group after that click the delete group button and it will ask the confirmation after clicking confirm message the group will delete.</p>

            </div>
        </div>
    </section>
    <section class="sc_fs_faq sc_card">
        <h2>How to Leave From a WhatsApp Group?</h2>
        <div>
            <div class="sc_fs_faq__content">


                <p>Like the delete method, there is the option name 'leave the group'. just simply click the left button and click the conformation and click the button and leave.</p>
    ...
    <p>Hey! this is the last part of the post we think you found the best group links that are engaged and active. you always come and find the wanted links and join. thank you for visiting other than the group PostTitle WhatsApp Group Links.</p>
</div>`;
function controller(){
    if(showPreArti){
